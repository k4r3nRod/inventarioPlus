...
<div class="container-fluid" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 80px 0;">
    <div class="container text-center">
        <h1 class="display-4 fw-bold mb-4">${message != null ? message : '¡Bienvenido al Sistema de Inventario!'}</h1>
        <p class="lead mb-4">${description != null ? description : 'Gestiona tu inventario de manera eficiente'}</p>
        <div class="mt-4">
